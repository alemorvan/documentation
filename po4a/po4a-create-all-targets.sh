...
[po4a_alias: md] text opt:\"-o markdown -o yfm_keys=title,contributors --addendum-charset=UTF-8 --localized-charset=UTF-8 --master-charset=UTF-8 --master-language=en_US --porefs=file --wrap-po=newlines --msgmerge-opt=--no-wrap \"
